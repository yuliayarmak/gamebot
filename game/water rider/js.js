...
let WaterRoad = function (image, y) {
    this.x = 0;
	this.y = y;
	this.loaded = false;
...
let Boat = function(image, x, y, isPlayer){
    this.x = x;
    this.y = y;
    this.loaded = false;
    this.dead = false;
...
let user = new Boat("img/bigboat.png", (canvas.width / 2)-20, canvas.height-48, true);
